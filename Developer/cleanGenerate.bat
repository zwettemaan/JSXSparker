...
IF NOT EXIST "%PROJECT_ROOT_DIR%BuildSettings%" (
    ...
    IF "!REPLY!" == "YES" (
        ...
        IF EXIST "!DESPACED_TARGET_NAME!_main.!TARGET_FILENAME_EXTENSION!" (
            DEL "!DESPACED_TARGET_NAME!_main.!TARGET_FILENAME_EXTENSION!"
        )
        ...
        IF EXIST "ReadMe for !DESPACED_TARGET_NAME!.txt" (
            DEL "ReadMe for !DESPACED_TARGET_NAME!.txt"
        )
        ...
        IF EXIST "CreativeDeveloperTools_ES" (
